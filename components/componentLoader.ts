...
import * as env from '#js/utility/environment/environmentManager';
import { PACKAGE_ROOT } from '#js/utility/packageUtils';
import { CONFIG_PARAMS, HDB_ROOT_DIR_NAME } from '#src/utility/hdbTerms';
import * as graphqlHandler from '#src/resources/graphql';
import * as graphqlQueryHandler from '#src/server/graphqlQuerying';
import * as roles from '#src/resources/roles';
import * as jsHandler from '#src/resources/jsResource';
import * as login from '#src/resources/login';
import * as REST from '#src/server/REST';
import * as fastifyRoutesHandler from '#src/server/fastifyRoutes';
import * as staticFiles from '#src/server/static';
import * as loadEnv from '#src/resources/loadEnv';
import harperLogger from '#js/utility/logging/harper_logger';
import * as dataLoader from '#src/resources/dataLoader';
import { watchDir, getWorkerIndex } from '#js/server/threads/manageThreads';
import { secureImport } from '#src/security/jsLoader';
import { server } from '#src/server/Server';
import { Resources } from '#src/resources/Resources';
import { table } from '#src/resources/databases';
import { startSocketServer } from '#src/server/threads/socketRouter';
import { getHdbBasePath } from '#js/utility/environment/environmentManager';
import * as operationsServer from '#src/server/operationsServer';
import * as auth from '#src/security/auth';
import * as mqtt from '#src/server/mqtt';
import { getConfigObj, resolvePath } from '#js/config/configUtils';
import { createReuseportFd } from '#src/server/serverHelpers/Request';
import { ErrorResource } from '#src/resources/ErrorResource';
import { Scope } from '#src/components/Scope';
import { ComponentV1, processResourceExtensionComponent } from '#src/components/ComponentV1';
import * as httpComponent from '#src/server/http';
import { Status } from '#src/server/status/index';
import { lifecycle as componentLifecycle } from '#src/components/status/index';
import { DEFAULT_CONFIG } from '#src/components/DEFAULT_CONFIG';
import type { PluginModule } from '#src/components/PluginModule';
import { getEnvBuiltInComponents } from '#src/components/Application';
