...
const auth = require('#js/security/fastifyAuth');
...
const { handleHDBError, hdbErrors } = require('#js/utility/errors/hdbError');
...
describe('Test serverHandlers.js module ', () => {
	...
	after(() => {
		sandbox.restore();
		rewire('#js/server/serverHelpers/serverHandlers');
	});
