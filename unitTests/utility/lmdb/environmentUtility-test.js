...
const DBIDefinition = require('#js/utility/lmdb/DBIDefinition');
const lmdb_env_util = require('#js/utility/lmdb/environmentUtility');
const rewire = require('rewire');
const rw_lmdb_env_util = rewire('#js/utility/lmdb/environmentUtility');
